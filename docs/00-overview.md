...
| Aiming & throwing | WIP — `throw-lab` (pose editor + swing + grip); see `paused-work-2026-08-08-arms.md` |
| Character skin / customization | WIP — `skin-lab` (tone/colour + age); see `paused-work-2026-08-08-arms.md` |
| Scoring | not started |
