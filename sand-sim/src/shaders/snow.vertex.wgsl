...
fn main(input: VertexInputs) -> FragmentInputs {
    ...
    if (cv.spacing < 1.0) {
        ...
        // Pebbles barely hold prints — the stones shift, they don't carve.
        // auxS.z is the pebble band; the damping MUST match the depth and
        // prepass stages or carved sand shadows against the wrong surface.
        h += deformHeight(
